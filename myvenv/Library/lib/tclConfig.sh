...
# installed.
TCL_PREFIX='K:/naive bayes and random/myvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='K:/naive bayes and random/myvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='K:/naive bayes and random/myvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IK:/naive bayes and random/myvenv\Library\include'
...
TCL_PACKAGE_PATH='K:/naive bayes and random/myvenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LK:/naive bayes and random/myvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='K:/naive bayes and random/myvenv\Library\lib\tclstub86.lib'
